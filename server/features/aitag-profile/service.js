...
const MAX_VIDEO_DURATION_SECONDS = 120; // Maximum 2 minutes limit
...
class ProfileService {
  ...
  /**
   * Generates secure GCS Signed Upload URL for Delivered Workflow Video (< 2 min limit)
   */
  ...
  /**
   * Attaches the uploaded video to the specified Delivered Workflow
   */
